...
if __name__ == "__main__":
    with open("/Users/rajesh/Desktop/rajesh/Archive/teaching/agentic_ai/BMGR-MAY2025-GIAI-2/KG_with_unstructure_data/data/industrial-revolution.txt", 'r') as infile:
        text = infile.read()
    configurations = load_config(
        "/Users/rajesh/Desktop/rajesh/Archive/teaching/agentic_ai/BMGR-MAY2025-GIAI-2/KG_with_unstructure_data/config.toml")
    chunk_size = configurations.get("chunking").get("chunk_size")
    overlap = configurations.get("chunking").get("overlap")
    chunk_result = chunk_text(text, chunk_size=chunk_size, overlap=overlap)
    print(chunk_result)